...
export function InterviewScheduleForm({
  ...
  if (isCompleted) return <InterviewCompletionMessage emailSent={emailSent} />;
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      ...
      {/* ── 面接・希望日 ── */}
      <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="mb-6 text-lg font-bold text-gray-900">面接・希望日</h2>
        ...
        {/* 面接方式 */}
        <div className="mb-8">
          <p className="mb-1 text-sm font-medium text-gray-700">面接方式</p>
          <p className="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900">
            {interviewMethod}
          </p>
        </div>
